...
/**
 * First after-hook spy: records its order via {@see RecordingSpy} and captures
 * the `($from, $to, $context)` it received.
 */
final class AfterHookA implements StateHookInterface
{
